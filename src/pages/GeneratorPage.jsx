...
import { generateComic, logout } from '../utils/storyGenerator'
import { saveStory } from '../utils/storyHistory'
import { getRandomStoryData } from '../utils/randomGen'
import { ArrowLeft, Wand2, Sparkles, Share2, Printer, LogOut, Video, Camera, Image as ImageIcon } from 'lucide-react'
...
export default function GeneratorPage() {
    ...
    const handleSavePDF = () => {
        ...
        printWindow.document.write(`
            ...
            <html>
            <head>
                <title>${formData.name}'s Adventure - Story Magic</title>
                <style>
            ...
            <body>
                <div class="header">
                    ...
                    <p>Generated by Story Magic • Theme: ${formData.theme} • Moral: ${formData.moral}</p>
                </div>
                ...
                <div class="footer">
                    Made with ❤️ by Story Magic | Age: ${formData.age} | Language: ${formData.language}
                </div>
            </body>
            </html>
        `)
                ...
                <div className="lg:col-span-4 sticky top-24">
                    <Card className="flex flex-col gap-6 shadow-2xl border-primary/10">
                        ...
                        <form onSubmit={handleGenerate} className="flex flex-col gap-4">
                            ...
                            <Input
                                label="Story Theme"
                                placeholder="e.g. Magical Library"
                            ...
                            >
                                ...
                                <Card className="bg-white/90 backdrop-blur-md border-none shadow-2xl relative overflow-hidden group">
                                    ...
                                    <div className="prose max-w-none">
                                        <p className="text-xl leading-relaxed text-slate-700 font-quicksand whitespace-pre-wrap first-letter:text-5xl first-letter:font-bubblegum first-letter:mr-1 first-letter:text-primary">
                                            {story}
                                        </p>
                                    </div>
                                </Card>
